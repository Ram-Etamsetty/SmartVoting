    ...
    return (
        <div className='bg-white flex flex-col lg:flex-row items-center justify-between mx-4 sm:mx-8 my-7 gap-8 lg:gap-4'>
            <div className='px-4 sm:px-6 py-5 w-full max-w-150 text-center lg:text-left flex flex-col items-center lg:items-start' >
                ...
                <p className='w-full text-gray-600 text-lg py-4'>Smart Voting guarantees election integrity,<br /> boosts voter
                    engagement and saves serious hours. <br /> It's free to test and free for up to 20 voters.</p>

                <div className='my-8'>
                    <NavLink to='get-started' className='px-6 py-6 bg-orange-400 tranisition duration-300 text-2xl text-white font-bold rounded-xl hover:bg-orange-500 '>
                        Start A Free Election
                    </NavLink>
                </div>
                <div className='flex flex-row gap-3 mt-15'>
                    <img src={ulu} className='h-24 w-18 mr-7' alt="" />
                    <p className='text-gray-400 text-sm italic max-w-md'>"Smart Voting is easy to use and intuitive"</p>
                </div>
            </div>
